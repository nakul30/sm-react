...
import { logoutUser } from '../state/actions-create/auth';
class Navbar extends React.Component {
  ...
  render() {
      // here i am getting auth from props 
...
// to get any state over here i use connect finction 
// so whene i need auth sttae at htath moment i converted this to class based functon and then added condition due to which i used connect finction over here else not needed 
